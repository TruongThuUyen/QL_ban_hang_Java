			...
			<div class="row" style = "display: flex; justify-content: center;">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="DangNhapController" style = "margin-bottom: 10px;">
							<input type="text" placeholder="username" name = "un-lg"/>
							<input type="password" placeholder="password" name = "pass-lg" />
							<button type="submit" class="btn btn-default">Login</button>
						</form>
						<%
						String tb =  request.getParameter("tb");
						if (tb != null)
							out.print("<b>Thông tin đăng nhập không chính xác!</b>");
						%>
					</div><!--/login form-->
				</div>
			</div>
